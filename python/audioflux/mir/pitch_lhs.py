...
class OpaquePitchLHS(Structure):
    _fields_ = []
...
class PitchLHS(Base):
    ...
    def __init__(self, samplate=32000, low_fre=32.0, high_fre=2000.0,
                 ...
                 harmonic_count=5):
        super(PitchLHS, self).__init__(pointer(OpaquePitchLHS()))
        ...
        fn = self._lib['pitchLHSObj_new']
        fn.argtypes = [POINTER(POINTER(OpaquePitchLHS)),
    ...
    def cal_time_length(self, data_length):
        ...
        out: int
        """
        fn = self._lib['pitchLHSObj_calTimeLength']
        fn.argtypes = [POINTER(OpaquePitchLHS), c_int]
        fn.restype = c_int
    ...
    def pitch(self, data_arr):
        ...
        fn = self._lib['pitchLHSObj_pitch']
        fn.argtypes = [POINTER(OpaquePitchLHS),
