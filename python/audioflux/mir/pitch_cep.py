...
class PitchCEP(Base):
    """
    Cepstrum Pitch Determination(CEP). Pitch is estimated by performing a second FFT transformation on
    the spectrum and using cepstral analysis. [#]_

    .. [#] Noll, Michael A. "Cepstrum Pitch Determination." The Journal of the Acoustical Society of
